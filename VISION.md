...
MecClaw is the industrial AI agent that actually does things.
It runs on your factory floor, in your SCADA systems, with your safety rules.
...
MecClaw started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> MecClaw.
...
Security in MecClaw is a deliberate tradeoff: strong defaults without killing capability.
...
MecClaw has an extensive plugin API.
...
- Code plugins run MecClaw plugin code and are appropriate for deeper runtime extension.
...
MecClaw docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
MecClaw supports MCP as both a server and a runtime integration surface.
...
MecClaw is currently terminal-first by design.
...
MecClaw is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep MecClaw hackable by default.
